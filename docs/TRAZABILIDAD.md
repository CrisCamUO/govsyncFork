...
| ----------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------- | ---------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CA-1 (registro exitoso, parcial)                | `[HU-01][BE-03]`, `[HU-01][FE-01]` | `cortes/application/casos_uso.py`, `cortes/api/router.py`                 | Probado                                  | `test_casos_uso_cortes.py` (3 pruebas) + `test_router_cortes.py::test_post_cortes_crea_en_borrador_201`                                 | 28 passed en local (2026-09-11)                                                                                                                                        |
| CA-2 (rechaza fecha futura)                     | `[HU-01][BE-01]`, `[HU-01][FE-01]` | `cortes/domain/entidades.py::Corte.validar_fecha`, `cortes/api/router.py` | Probado                                  | `test_cortes.py::test_rechaza_fecha_futura_con_motivo` + `test_router_cortes.py::test_post_cortes_fecha_futura_devuelve_422_con_motivo` | 28 passed en local (2026-09-11)                                                                                                                                        |
...
| CA-8 (endpoint)                                 | `[HU-01][FE-01]`                   | `cortes/api/router.py`                                                    | Implementado/Probado                     | `test_router_cortes.py::test_get_cortes_devuelve_historico_200` + `test_get_cortes_id_devuelve_detalle_200`                             | 28 passed en local (2026-09-11). Ver `docs/DECISIONES.md` D8: reconcilia con `CASOS_DE_PRUEBA.md`, que marcaba este CA "Probado" prematuramente a nivel de aplicación. |
