...
| CA-5 (reutilización automática PDT + municipio) | `[HU-01][BE-04]`                   | `entidades.py` + `casos_uso.py`                                           | Implementado (dominio/aplicación) sobre un supuesto aún sin ratificar — D3 en `docs/DECISIONES.md` sigue `SUPUESTO`; probado solo con repositorio en memoria | `test_casos_uso_cortes.py::test_crear_corte_reutiliza_pdt_y_proyectos_del_ultimo_registrado_de_la_misma_vigencia`, `test_crear_corte_reutilizacion_copia_los_datos_de_origen` | 97 passed en local (2026-09-13); falta prueba con repositorio real (SQLAlchemy)                                                                                        |
| CA-6 (opción de reemplazar reutilizados)        | `[HU-01][BE-04]`                   | idem                                                                      | Implementado (vía el mecanismo genérico de HU-06)                                                                                                            | `test_repositorios_cortes.py::test_registrar_archivo_inserta_y_luego_reemplaza`                                                                                               | 97 passed en local (2026-09-13)                                                                                                                                        |
